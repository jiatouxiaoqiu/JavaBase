...
public class AIO {
        ...
        try{
            ...
            CompletionHandler<Integer, Object> handler = new CompletionHandler<Integer, Object>() {
                ...
                public void failed(Throwable e, Object attachment) {
                    System.err.println("Attachment: " + attachment + " failed with:"); e.printStackTrace();
                }
            };
    ...
    public static void main(String[] args) {
        String filepath = "/Users/mx/Documents/java/dog_api/src/main/java/cn/ebing/dog/api/utils/io/aio.text";
        writeFile(filepath);
        readFile(filepath);
    }
}
